...
async function migrate() {
    ...
    const candidates = [
        ...
        path.join(process.cwd(), "packages", "orbit-server", "prisma", "migrations"),
...
switch (command) {
    ...
    case "serve":
        ...
        break;
    default:
        console.log(`orbit-server - portable distribution
...
Environment variables:
  ...
  ORBIT_MASTER_SECRET  Required: master secret for auth/encryption
`);
