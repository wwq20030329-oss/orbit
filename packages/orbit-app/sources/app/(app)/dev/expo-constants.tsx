...
export default function ExpoConstantsScreen() {
    ...
    const updatesState = getExpoUpdatesState();
    const updatesManifest = updatesState.manifest;
    const updateId = updatesState.updateId;
    const releaseChannel = updatesState.releaseChannel;
    const channel = updatesState.channel;
    const isEmbeddedLaunch = updatesState.isEmbeddedLaunch;
