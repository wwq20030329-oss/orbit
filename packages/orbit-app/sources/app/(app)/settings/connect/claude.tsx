...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="orbit connect claude" />
            {/* <OAuthView
                name="Claude"
                command="orbit connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `orbit connect ${props.name.toLowerCase()}`;
