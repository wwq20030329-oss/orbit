...
describe('sessionFileLinks', () => {
    const sessionRoot = '/Users/kirilldubovitskiy/projects/orbit';

    it('parses absolute file refs with line numbers', () => {
        const result = parseSessionFileLink('/Users/kirilldubovitskiy/projects/orbit/packages/orbit-cli/src/codex/runCodex.ts:594', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: '/Users/kirilldubovitskiy/projects/orbit/packages/orbit-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/orbit/packages/orbit-cli/src/codex/runCodex.ts',
            relativePath: 'packages/orbit-cli/src/codex/runCodex.ts',
    ...
    it('parses relative file refs with line and column numbers', () => {
        const result = parseSessionFileLink('packages/orbit-cli/src/codex/runCodex.ts:594:2', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: 'packages/orbit-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/orbit/packages/orbit-cli/src/codex/runCodex.ts',
            relativePath: 'packages/orbit-cli/src/codex/runCodex.ts',
            withinSessionRoot: true,
            line: 594,
    ...
    it('splits bare text into plain and linked segments', () => {
        const result = splitSessionFileText('Open packages/orbit-cli/src/codex/runCodex.ts:594 please.', sessionRoot);

        expect(result).toEqual([
            { text: 'Open ', link: null },
            {
                text: 'packages/orbit-cli/src/codex/runCodex.ts:594',
                link: {
                    path: 'packages/orbit-cli/src/codex/runCodex.ts',
                    absolutePath: '/Users/kirilldubovitskiy/projects/orbit/packages/orbit-cli/src/codex/runCodex.ts',
                    relativePath: 'packages/orbit-cli/src/codex/runCodex.ts',
    ...
    it('does not turn slash-separated prose into file refs', () => {
        expect(splitSessionFileText(
            'Codex then starts/resumes turns with backend default model. I’m checking CLI docs/tests to confirm there is intentionally no orbit codex model set or --model surface today.',
            sessionRoot,
        )).toEqual([
            {
                text: 'Codex then starts/resumes turns with backend default model. I’m checking CLI docs/tests to confirm there is intentionally no orbit codex model set or --model surface today.',
                link: null,
            },
        ]);
    });
    ...
    it('resolves viewer input to an absolute path', () => {
        expect(resolveSessionFilePath('packages/orbit-app/README.md', sessionRoot)).toEqual({
            path: 'packages/orbit-app/README.md',
            absolutePath: '/Users/kirilldubovitskiy/projects/orbit/packages/orbit-app/README.md',
            relativePath: 'packages/orbit-app/README.md',
            withinSessionRoot: true,
            line: null,
            column: null,
        });
