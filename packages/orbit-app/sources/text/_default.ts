...
export const en = {
    ...
    sessionInfo: {
        ...
        deleteSessionSubtitle: 'Permanently remove this session and its local CLI history',
        deleteSessionConfirm: 'Delete Session Permanently?',
        deleteSessionWarning: 'This action cannot be undone. Orbit will delete this session and also remove the matching local CLI history from the connected machine.',
        failedToDeleteSession: 'Failed to delete session',
        sessionDeleted: 'Session deleted successfully',
        deleteProject: 'Delete Project',
        deleteProjectWarning: 'This action cannot be undone. Orbit will delete all sessions in this project and also remove the matching local CLI history from the connected machine.',
