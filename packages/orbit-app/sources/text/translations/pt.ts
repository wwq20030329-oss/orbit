...
/**
 * Portuguese (Brazilian) translations for the Orbit app
...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Orbit é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Você atingiu o número máximo de conversas de voz este mês. Podemos adicionar uso de voz sob demanda no futuro — por favor, abra um issue em github.com/wwq20030329-oss/orbit/issues se você atingir este limite.',
    ...
    server: {
        ...
        notValidOrbitServer: 'Não é um servidor Orbit válido',
    ...
    sessionInfo: {
        ...
        orbitSessionIdCopied: 'ID da sessão Orbit copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Orbit',
        orbitSessionId: 'ID da sessão Orbit',
        ...
        nativeCliSessionId: 'ID da sessão CLI nativa',
        nativeCliSessionIdCopied: 'ID da sessão CLI nativa copiado para a área de transferência',
        ...
        failedToCopyNativeCliSessionId: 'Falha ao copiar ID da sessão CLI nativa',
        ...
        updateCliInstructions: 'Por favor execute npm install -g orbit@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Orbit CLI',
            runIt: 'Execute',
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Remover permanentemente sua conta e todos os dados',
        deleteAccountConfirm: 'Tem certeza de que deseja excluir sua conta? Esta ação não pode ser desfeita. Todos os seus dados serão removidos permanentemente.',
        logout: 'Sair',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Orbit. Isso permitirá que o terminal envie e receba mensagens com segurança.',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `orbit daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g orbit@latest`',
