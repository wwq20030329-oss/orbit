...
/**
 * Polish translations for the Orbit app
...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Orbit to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Osiągnąłeś maksymalną liczbę rozmów głosowych w tym miesiącu. Możliwe, że w przyszłości dodamy głosowe korzystanie na żądanie — prosimy o zgłoszenie na github.com/wwq20030329-oss/orbit/issues, jeśli napotkasz ten limit.',
    ...
    server: {
        ...
        notValidOrbitServer: 'To nie jest prawidłowy serwer Orbit',
    ...
    sessionInfo: {
        ...
        orbitSessionIdCopied: 'ID sesji Orbit skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Orbit',
        orbitSessionId: 'ID sesji Orbit',
        ...
        nativeCliSessionId: 'ID natywnej sesji CLI',
        nativeCliSessionIdCopied: 'ID natywnej sesji CLI skopiowane do schowka',
        ...
        failedToCopyNativeCliSessionId: 'Nie udało się skopiować ID natywnej sesji CLI',
        ...
        orbitHome: 'Katalog domowy Orbit',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g orbit@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj Orbit CLI',
            runIt: 'Uruchom je',
    ...
    settingsAccount: {
        ...
        deleteAccountConfirm: 'Czy na pewno chcesz usunąć swoje konto? Tej operacji nie można cofnąć. Wszystkie Twoje dane zostaną trwale usunięte.',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Orbit. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `orbit daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g orbit@latest`',
