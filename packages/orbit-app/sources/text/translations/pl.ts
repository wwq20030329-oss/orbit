...
export const pl: TranslationStructure = {
    ...
    sessionRun: {
        running: 'Myslenie',
        connecting: 'Laczenie',
        permissionRequired: 'Oczekiwanie na uprawnienie',
        reconnecting: 'Rozlaczono, ponowne laczenie',
    ...
    newSession: {
        ...
        quickModeTitle: 'Zacznij w trybie szybkim',
        expertModeTitle: 'Zacznij w trybie eksperckim',
        quickModeSubtitle: 'Najlepszy do codziennej pracy i szybszego startu.',
        expertModeSubtitle: 'Sprawdź maszynę, projekt i model przed utworzeniem sesji.',
        openAdvanced: 'Otwórz zaawansowany kreator',
        machineLabel: 'Maszyna',
        projectLabel: 'Projekt',
        modeLabel: 'Tryb',
        customPath: 'Własna ścieżka',
        ...
        messagePlaceholder: 'Wyślij wiadomość lub przytrzymaj, aby mówić',
    ...
    tools: {
        ...
        desc: {
            ...
            moreFiles: ({ count }: { count: number }) => `+${count} ${plural({ count, one: 'plik', few: 'pliki', many: 'plików' })}`,
