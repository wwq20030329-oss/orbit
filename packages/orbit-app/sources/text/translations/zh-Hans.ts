...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        deleteSession: '删除会话',
        deleteSessionSubtitle: '永久删除此会话及其本地 CLI 历史',
        deleteSessionConfirm: '永久删除会话？',
        deleteSessionWarning: '此操作无法撤销。Orbit 会删除这条会话，同时从已连接电脑上移除对应的本地 CLI 历史记录。',
        failedToDeleteSession: '删除会话失败',
        sessionDeleted: '会话删除成功',
        deleteProject: '删除项目',
        deleteProjectWarning: '此操作无法撤销。Orbit 会删除这个项目下的所有会话，同时从已连接电脑上移除对应的本地 CLI 历史记录。',
