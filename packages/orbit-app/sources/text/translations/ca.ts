...
export const ca: TranslationStructure = {
    ...
    sessionRun: {
        running: 'Pensant',
        connecting: 'Connectant',
        permissionRequired: 'Esperant permis',
        reconnecting: 'Desconnectat, reconnectant',
        disconnected: 'Desconnectat',
        archived: 'Arxivat',
        stop: 'Atura',
    },
    ...
    newSession: {
        ...
        quickMode: 'Mode ràpid',
        expertMode: 'Mode expert',
        quickModeTitle: 'Comença amb el mode ràpid',
        expertModeTitle: 'Comença amb el mode expert',
        quickModeSubtitle: 'Ideal per a la feina diària i per començar més ràpid.',
        expertModeSubtitle: 'Revisa màquina, projecte i model abans de crear la sessió.',
        openAdvanced: 'Obrir el compositor avançat',
        machineLabel: 'Màquina',
        projectLabel: 'Projecte',
        modeLabel: 'Mode',
        customPath: 'Ruta personalitzada',
        recentProjects: 'Projectes recents',
        noRecentProjects: 'Encara no hi ha projectes recents',
        advancedSettings: 'Configuració avançada',
        noMachineSelected: 'Selecciona primer una màquina',
        messagePlaceholder: 'Envia un missatge o mantén premut per parlar',
        createDirectoryTitle: 'Crear directori?',
        createDirectoryBody: ({ directory }: { directory: string }) => `El directori '${directory}' no existeix. El vols crear?`,
    },
    ...
    tools: {
        ...
        desc: {
            ...
            moreFiles: ({ count }: { count: number }) => `+${count} fitxers més`,
