...
/**
 * Catalan translations for the Orbit app
...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Orbit és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    errors: {
        ...
        voiceConversationLimitReached: 'Has assolit el nombre màxim de converses de veu aquest mes. És possible que en el futur afegim ús de veu sota demanda — si us plau, crea un issue a github.com/wwq20030329-oss/orbit/issues si arribes a aquest límit.',
    ...
    server: {
        ...
        notValidOrbitServer: 'No és un servidor Orbit vàlid',
    ...
    sessionInfo: {
        ...
        orbitSessionIdCopied: 'ID de la sessió de Orbit copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Orbit',
        orbitSessionId: 'ID de la sessió de Orbit',
        ...
        nativeCliSessionId: 'ID de la sessió del CLI natiu',
        nativeCliSessionIdCopied: 'ID de la sessió del CLI natiu copiat al porta-retalls',
        ...
        failedToCopyNativeCliSessionId: 'Ha fallat copiar l\'ID de la sessió del CLI natiu',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g orbit@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Orbit CLI',
            runIt: 'Executa\'l',
    ...
    settingsAccount: {
        ...
        deleteAccountConfirm: 'Segur que vols suprimir el teu compte? Aquesta acció no es pot desfer. Totes les teves dades s\'eliminaran permanentment.',
        logout: 'Tanca la sessió',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Orbit. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `orbit daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `npm install -g orbit@latest`',
