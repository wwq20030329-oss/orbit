...
export const MetadataSchema = z.object({
    ...
    orbitHomeDir: z.string().optional(), // Orbit configuration directory 
...
export const MachineMetadataSchema = z.object({
    host: z.string(),
    platform: z.string(),
    orbitCliVersion: z.string(),
    orbitHomeDir: z.string(), // Directory for Orbit auth, settings, logs (usually .orbit/ or .orbit-dev/)
    ...
    shutdownSource: z.enum(['orbit-app', 'orbit-cli', 'os-signal', 'unknown']).optional(),
    ...
    resumeSupport: z.object({
        ...
        requiresOrbitAgentAuth: z.boolean(),
        orbitAgentAuthenticated: z.boolean(),
        detectedAt: z.number(),
    }).optional(),
});
