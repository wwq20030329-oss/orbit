...
const STABLE_DIR = path.join(os.homedir(), '.orbit');
const DEV_DIR = path.join(os.homedir(), '.orbit-dev');

console.log('🔧 Setting up Orbit CLI development environment...\n');
...
const envrcContent = `# Orbit CLI environment (for direnv users)
# Automatically sets ORBIT_HOME_DIR based on directory
#
# To use: cd to orbit-dev directory, run: direnv allow
export ORBIT_HOME_DIR="$HOME/.orbit-dev"
export ORBIT_VARIANT="dev"
`;
