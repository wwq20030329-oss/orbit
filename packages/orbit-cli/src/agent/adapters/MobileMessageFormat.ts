 ...
 *
 * This module defines the message format expected by the Orbit mobile app.
 * Messages from any agent (Gemini, Codex, Claude, etc.) are transformed
 * to this format before being sent through the Orbit server.
 *
...
export interface MobileMessageMeta {
  ...
  model?: string | null;
  /** Thought / reasoning effort if applicable */
  effortLevel?: string;
}
