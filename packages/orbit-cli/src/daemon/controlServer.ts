...
export function startDaemonControlServer({
  ...
  onOrbitSessionWebhook: (sessionId: string, metadata: Metadata) => void;
  ...
  return new Promise((resolve) => {
    ...
    typed.post('/session-started', {
      ...
      onOrbitSessionWebhook(sessionId, metadata);
    ...
    typed.post('/list', {
      ...
      return { 
        children: children
          .filter(child => child.orbitSessionId !== undefined)
          .map(child => ({
            startedBy: child.startedBy,
            orbitSessionId: child.orbitSessionId!,
            pid: child.pid
          }))
      }
    });
