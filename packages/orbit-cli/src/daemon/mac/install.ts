/**
 * Installation script for Orbit daemon using macOS LaunchDaemons.
 * 
 * NOTE: This installation method is currently NOT USED in favor of auto-starting 
 * the daemon when the user runs the orbit command.
 * 
 ...
 * 2. We assume users will run orbit frequently (every time they open their laptop)
...
export async function install(): Promise<void> {
    try {
        ...
        // Get the path to the Orbit CLI executable.
        const orbitPath = process.argv[0]; // Node.js executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <string>${os.homedir()}/.orbit/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.orbit/daemon.log</string>
        ...
        logger.info('Check logs at ~/.orbit/daemon.log');
