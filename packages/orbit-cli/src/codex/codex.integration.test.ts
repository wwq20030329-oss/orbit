...
import { afterEach, describe, it, expect, type TestContext } from "vitest";
...
describe.skipIf(!(await isCodexAppServerAvailable()))(
    ...
    () => {
        ...
        it("should complete turn gracefully after permission cancel", async (ctx) => {
        ...
        it("should preserve context when continuing after cancel", async (ctx) => {
            driver = new CodexDriver();
            await driver.connect();
        ...
        it("should abort turn via interruptTurn while permission is pending", async (ctx) => {
            driver = new CodexDriver();
            await driver.connect();
        ...
        it("should preserve context when continuing after interruptTurn abort", async (ctx) => {
            driver = new CodexDriver();
            await driver.connect();
