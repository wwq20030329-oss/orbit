...
export const zhHans: TranslationStructure = {
    ...
    settings: {
        ...
        about: '关于',
        aboutFooter: 'Orbit Coder 是一个 Codex 和 Claude Code 移动客户端。它采用端到端加密，您的账户仅存储在本地设备上。与 Anthropic 无关联。',
        whatsNew: '更新日志',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 Orbit 服务器',
        changeServer: '更改服务器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Orbit 会话 ID 已复制到剪贴板',
        failedToCopySessionId: '复制 Orbit 会话 ID 失败',
        happySessionId: 'Orbit 会话 ID',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有终端正在请求连接到您的 Orbit Coder 账户。这将允许终端安全地发送和接收消息。',
