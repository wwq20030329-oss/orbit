...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Orbit Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor Orbit válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão Orbit copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Orbit',
        happySessionId: 'ID da sessão Orbit',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Orbit Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',
