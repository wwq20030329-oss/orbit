...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Orbit Coder to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer Orbit',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sesji Orbit skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Orbit',
        happySessionId: 'ID sesji Orbit',
        ...
        happyHome: 'Katalog domowy Orbit',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Orbit Coder. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
