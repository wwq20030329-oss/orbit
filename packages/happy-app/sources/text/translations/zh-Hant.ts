...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        about: '關於',
        aboutFooter: 'Orbit Coder 是一個 Codex 和 Claude Code 行動用戶端。它採用端對端加密，您的帳戶僅儲存在本機裝置上。與 Anthropic 無關聯。',
        whatsNew: '更新日誌',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 Orbit 伺服器',
        changeServer: '更改伺服器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Orbit 工作階段 ID 已複製到剪貼簿',
        failedToCopySessionId: '複製 Orbit 工作階段 ID 失敗',
        happySessionId: 'Orbit 工作階段 ID',
    ...
    terminal: {
        ...
        terminalRequestDescription: '有終端正在請求連線到您的 Orbit Coder 帳戶。這將允許終端安全地傳送和接收訊息。',
