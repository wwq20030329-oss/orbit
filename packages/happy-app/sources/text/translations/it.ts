...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Orbit Coder è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un Orbit Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione Orbit copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Orbit',
        happySessionId: 'ID sessione Orbit',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Orbit Coder. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
