...
export const ja: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'Orbit CoderはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
    ...
    server: {
        ...
        notValidHappyServer: '有効なOrbit Serverではありません',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Orbit Session IDがクリップボードにコピーされました',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがOrbit Coderアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',
