...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Orbit Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor Orbit válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de Orbit copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Orbit',
        happySessionId: 'ID de sesión de Orbit',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Orbit Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
