...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Orbit Coder is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Orbit Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Orbit Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Orbit Session ID',
        happySessionId: 'Orbit Session ID',
        ...
        resumeSessionNeedsHappyAgent: 'Resume is unavailable on this machine. Run `orbit-agent auth login` to enable it.',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Orbit Coder account. This will allow the terminal to send and receive messages securely.',
